...
- Name: complete-audit.spec.ts >> Doggy Lobby - Complete QA Audit >> 2. NAVIGATION LINKS >> Shop link works
- Location: tests/complete-audit.spec.ts:40:9
...
Call log:
  - waiting for locator('text=Shop')
    - locator resolved to 4 elements. Proceeding with the first one: <span class="relative z-10">Shop</span>
...
- generic [active] [ref=e1]:
  ...
  - main [ref=e7]:
    ...
    - generic [ref=e161]:
      ...
      - generic [ref=e166]:
        - paragraph [ref=e167]: Excellent owner.
        - heading "Amit" [level=4] [ref=e168]
        - paragraph [ref=e169]: 2 years ago
        - generic [ref=e170]:
          - button [ref=e171]
          - button [ref=e172]
          - button [ref=e173]
  ...
  - alert [ref=e422]: Faridabad's Premium Destination For Happy Pets
```
