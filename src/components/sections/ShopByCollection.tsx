  ...
  return (
    <div id="collections" className="pt-32 pb-20 px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
        {collections.map((col) => (
          <Link key={col.type} href={`/collections/${col.type}`} className="relative aspect-square rounded-2xl overflow-hidden cursor-pointer hover:shadow-2xl block w-full text-left">
