...
export default function Hero() {
  ...
  return (
    <section ref={containerRef} className="relative min-h-screen h-auto md:h-screen md:min-h-[800px] flex items-center justify-center overflow-hidden bg-black py-24 md:py-0">
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10 flex flex-col items-center md:items-start text-center md:text-left pt-32 md:pt-24 mt-10 pb-32 md:pb-24">
