...
export function AmbientBackground() {
  ...
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none z-[-1] hidden md:block">
      <div
        className="absolute top-[-10%] left-[-10%] w-[50vw] h-[50vw] rounded-full bg-[var(--color-brand-orange)]/5 blur-[80px]"
      />
      <div
        className="absolute bottom-[-10%] right-[-10%] w-[60vw] h-[60vw] rounded-full bg-blue-500/5 blur-[80px]"
      />
    </div>
  )
}
